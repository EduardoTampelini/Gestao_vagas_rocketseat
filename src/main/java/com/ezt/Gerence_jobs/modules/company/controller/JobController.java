package com.ezt.Gerence_jobs.modules.company.controller;

import com.ezt.Gerence_jobs.modules.company.dto.CreateJobDTO;
import com.ezt.Gerence_jobs.modules.company.entities.JobEntity;
import com.ezt.Gerence_jobs.modules.company.useCases.CreateJobUseCase;
...
public class JobController {
    ...
    public JobEntity create(@Valid @RequestBody CreateJobDTO createJobDTO, HttpServletRequest request) {
        ...
        var jobEntity = JobEntity.builder()
                .benefit(createJobDTO.getBenefits())
